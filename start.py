...
def register():
    call(["python", "registerGUI.py"], cwd=r'C:\Users\Xyron\Documents\GitHub\CFIS-criminal-face-identification-system')
def VideoSurveillance():
    surveillance.App()
    # call(["python", "surveillance.py"], cwd=r'C:\\Users\\Xyron\\Documents\\GitHub\\CFIS-criminal-face-identification-system')
def detectCriminal():
    # detect.App()
    call(["python", "detect.py"], cwd=r'C:\Users\Xyron\Documents\GitHub\CFIS-criminal-face-identification-system')
