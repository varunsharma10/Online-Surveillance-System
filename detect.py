...
label_1 = Label(root, text="Select Photo to detect faces",
                bg='#382273', fg='white', width=50, font=("bold", 15))
label_1.place(x=30, y=60)
label_177 = Label(root, text="Double click on record to see details",
                  bg='#382273', fg='white', width=50, font=("bold", 15))
label_177.place(x=700, y=48)

label_0 = Label(root, text="Criminal Face Identification System",
                width=87, font=("bold", 20), anchor=CENTER, bg="grey", fg="white")
...
def viewdetail(a):
    ...
    print(rows)
    for row in rows:
        label_n = Label(root, text=row[1], bg="#382273",
                        fg='white', width=20, font=("bold", 12))
        label_n.place(x=1100, y=400)
        label_f = Label(root, text=row[3], bg="#382273",
                        fg='white', width=20, font=("bold", 12))
        label_f.place(x=1100, y=430)
        label_m = Label(root, text=row[4], bg="#382273",
                        fg='white', width=20, font=("bold", 12))
        label_m.place(x=1100, y=460)
        label_g = Label(root, text=row[2], bg="#382273",
                        fg='white', width=20, font=("bold", 12))
        label_g.place(x=1100, y=490)
        label_r = Label(root, text=row[5], bg="#382273",
                        fg='white', width=20, font=("bold", 12))
        label_r.place(x=1100, y=520)
        label_bl = Label(
            root, text=row[6], bg="#382273", fg='white', width=20, font=("bold", 12))
        label_bl.place(x=1100, y=550)
        label_b = Label(root, text=row[7], bg="#382273",
                        fg='white', width=20, font=("bold", 12))
        label_b.place(x=1100, y=580)
        label_n = Label(root, text=row[8], bg="#382273",
                        fg='white', width=20, font=("bold", 12))
        label_n.place(x=1100, y=610)
        label_c = Label(root, text=row[9], width=70,
                        bg="#382273", font=("bold", 15), fg="red")
        label_c.place(x=630, y=680)

        # it print all records in the database
    conn.close()
    ################################################################################
    label_name = Label(root, text="Name", bg="#382273",
                       fg='yellow', width=20, font=("bold", 12))
    label_name.place(x=930, y=400)
    label_father = Label(root, text="FatherName", bg="#382273",
                         fg='yellow', width=20, font=("bold", 12))
    label_father.place(x=930, y=430)
    label_mother = Label(root, text="MotherName", bg="#382273",
                         fg='yellow', width=20, font=("bold", 12))
    label_mother.place(x=930, y=460)
    label_gender = Label(root, text="Gender", bg="#382273",
                         fg='yellow', width=20, font=("bold", 12))
    label_gender.place(x=930, y=490)
    label_religion = Label(root, text="Religion", bg="#382273",
                           fg='yellow', width=20, font=("bold", 12))
    label_religion.place(x=930, y=520)
    label_bloodgroup = Label(
        root, text="Blood Group", bg="#382273", fg='yellow', width=20, font=("bold", 12))
    label_bloodgroup.place(x=930, y=550)
    label_body = Label(root, text="BodyMark", bg="#382273",
                       fg='yellow', width=20, font=("bold", 12))
    label_body.place(x=930, y=580)
    label_nat = Label(root, text="Nationality", bg="#382273",
                      fg='yellow', width=20, font=("bold", 12))
    label_nat.place(x=930, y=610)
    label_crime = Label(root, text="Crime :", bg="#382273",
...
def View():
    ...
    if process_this_frame:
        ...
        for face_encoding in face_encodings:
            ...
            label_Match = Label(root, text=a, bg="#382273",
...
btn = Button(text="Select photo", bg='yellow', width=20,
...
b2 = Button(text="View Matching Records", width=30, height=2,
            command=View, bg='red', fg="white").place(x=165, y=620)
